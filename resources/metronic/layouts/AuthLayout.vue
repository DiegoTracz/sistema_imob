<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    >
      <!--begin::Content-->
      <div
        class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100 bg-primary"
      >
        ...
        >
          Transforme a Gestão da Sua Imobiliária com Immo!
        </h1>
        <!--end::Title-->

        <!--begin::Text-->
        <div class="d-none d-lg-block text-white fs-base text-center">
          Aumente sua eficiência e conquiste mais clientes com a plataforma líder em gestão de imobiliárias e corretores. Não perca a chance de elevar seu negócio ao próximo nível!
        </div>
        <!--end::Text-->
      </div>
      <!--end::Content-->
