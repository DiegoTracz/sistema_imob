...
import KTSearch from "@metronic/layouts/default-layout/components/search/Search.vue";
import KTThemeModeSwitcher from "@metronic/layouts/default-layout/components/theme-mode/ThemeModeSwitcher.vue";
