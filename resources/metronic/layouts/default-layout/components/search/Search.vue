...
import Results from "@metronic/layouts/default-layout/components/search/partials/Results.vue";
import PartialMain from "@metronic/layouts/default-layout/components/search/partials/Main.vue";
import Empty from "@metronic/layouts/default-layout/components/search/partials/Empty.vue";
import MenuComponent from "@metronic/components/menu/MenuComponent.vue";
