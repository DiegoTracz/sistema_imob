...
import { config } from "@metronic/layouts/default-layout/config/helper";
import CodeHighlighter from "@metronic/components/highlighters/CodeHighlighter.vue";
import { themeName } from "@metronic/core/helpers/system";
import { LS_CONFIG_NAME_KEY } from "@metronic/stores/config";
