...
import type LayoutConfigTypes from "@metronic/layouts/default-layout/config/types";
import layoutConfig from "@metronic/layouts/default-layout/config/DefaultLayoutConfig";
