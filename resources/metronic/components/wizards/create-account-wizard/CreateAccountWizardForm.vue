...
import type {
  ...
  IStep4,
  ICreateAccount,
} from "@metronic/components/wizards/create-account-wizard/types";
import CreateAccountStep1 from "@metronic/components/wizards/create-account-wizard/steps/CreateAccountStep1.vue";
import CreateAccountStep2 from "@metronic/components/wizards/create-account-wizard/steps/CreateAccountStep2.vue";
import CreateAccountStep3 from "@metronic/components/wizards/create-account-wizard/steps/CreateAccountStep3.vue";
import CreateAccountStep4 from "@metronic/components/wizards/create-account-wizard/steps/CreateAccountStep4.vue";
import CreateAccountStep5 from "@metronic/components/wizards/create-account-wizard/steps/CreateAccountStep5.vue";
