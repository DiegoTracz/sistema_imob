...
import TableHeadRow from "@metronic/components/kt-datatable/table-partials/table-content/table-head/TableHeadRow.vue";
import TableBodyRow from "@metronic/components/kt-datatable/table-partials/table-content/table-body/TableBodyRow.vue";
import Loading from "@metronic/components/kt-datatable/table-partials/Loading.vue";
