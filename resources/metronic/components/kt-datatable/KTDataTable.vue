...
import TableContent from "@metronic/components/kt-datatable/table-partials/table-content/TableContent.vue";
import TableFooter from "@metronic/components/kt-datatable/table-partials/TableFooter.vue";
